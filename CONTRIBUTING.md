...
issue](https://github.com/cisagov/resume/issues) in this
...
request](https://github.com/cisagov/resume/pulls), you will
...
```console
cd resume
pyenv virtualenv <python_version_to_use> resume
pyenv local resume
